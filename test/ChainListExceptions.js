...
contract("ChainList", function(accounts){
  ...
  it("should throw an excpetion if you try to buy an article that does not exist", function(){
    return ChainList.deployed().then(function(instance) {
      chainListInstance = instance;
  ...
  it("should throw an exception if you buy an article you have listed", function(){
    return ChainList.deployed().then(function(instance){
      chainListInstance = instance;
  ...
  it("should throw an exception if you buy an article for a value different to its price", function(){
    return ChainList.deployed().then(function(instance){
      chainListInstance = instance;
  ...
  it("should throw an exception if you buy an article that was already sold", function(){
    return ChainList.deployed().then(function(instance){
      chainListInstance = instance;
